...
ResidualElectricitySensor::ResidualElectricitySensor()
{

}

bool ResidualElectricitySensor::apply()
{
    cmsConfig cfg;
...
void ResidualElectricitySensor::setDefConfig(SensorData::sensorType sensorType)
{
    if (sensorType != SensorData::PRC) {
        return ;
    }
    ...
    prcdef.base.wm = SensorData::ABP;
    prcdef.base.addr = "50000001";
    prcdef.base.appskey = "48c60a4d148c719923b14a8f4d44da29";
    prcdef.base.nwskey = "48c60a4d148c719923b14a8f4d44da29";
    prcdef.base.channelNum = 10;

    prcdef.st = SensorData::PRC;
    prcdef.lowtv = 0;
    prcdef.lowtvUnit = "mA";
    prcdef.hightv = 300;
    prcdef.hightvUnit = "mA";
    prcdef.variation = 0;
    prcdef.variationUnit = "mA";

    prcdef.sampleTime = 120;
    prcdef.upTransTime = 14400;
    prcdef.reTrans = 2;

    setConfig(prcdef);
}

bool ResidualElectricitySensor::presetIsModify(const QString &name)
{
    return IsModify(SensorData::PRC, name);
}

bool ResidualElectricitySensor::saveAsPreset(const QString &name)
{
    return saveAs(SensorData::PRC, name);
}

bool ResidualElectricitySensor::loadPreset(const QString &name)
{
    return load(SensorData::PRC, name);
}
